...
<template>
  <view class="about">
	...
	<view class="titleZ text-center align-center">
		...
		<view class="contentZ">
			<text class="text-xl">项目作者:张迎乐，一名7年经验乌黑秀发的九零后标准程序员，坐标河北！</text>
		</view>
	</view>
	...
	<view class="titleZ text-center align-center margin-top-xl">
		...
		<view class="contentZ margin-top-lg">
			<text class="text-xl text-bold">想学习</text>
			<text class="text-xl">：软件技术开发培训（实战项目），赶快加入我们微信群</text>
		</view>
		<view class="contentZ" style="margin-top: 40rpx;">
			<text class="text-xl text-bold">有项目</text>
